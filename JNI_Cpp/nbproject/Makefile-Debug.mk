...
${OBJECTDIR}/TestMaven.o: TestMaven.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../../Library/Java/JavaVirtualMachines/azul-1.8.0_372/Contents/Home/include -I../../../Library/Java/JavaVirtualMachines/azul-1.8.0_372/Contents/Home/include/darwin -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TestMaven.o TestMaven.cpp
